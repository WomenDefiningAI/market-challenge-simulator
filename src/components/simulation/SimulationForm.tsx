		...
		<div className="w-full">
				...
				<Card className="bg-white/95 backdrop-blur-sm shadow-xl">
					<div className="grid grid-cols-2 gap-8 p-8">
						<div className="space-y-4">
							<Label htmlFor="companyInfo" className="text-lg">Company Information</Label>
							<Textarea
								id="companyInfo"
								value={companyInfo}
						...
						<div className="space-y-4">
							<Label htmlFor="marketChallenge" className="text-lg">Market Challenge</Label>
							<Textarea
								id="marketChallenge"
						...
						<div className="col-span-2">
							<Label htmlFor="apiKey" className="text-lg">OpenAI API Key</Label>
			...
			{result && !showReport && (
				<div className="mt-8 space-y-8">
					<Card className="bg-white/95 backdrop-blur-sm shadow-xl">
						<div className="p-8">
							<h3 className="text-2xl font-semibold mb-6">Raw Simulation Results</h3>
							<div className="space-y-6">
								<div>
									<h4 className="text-xl font-medium mb-3">Generated Solutions:</h4>
									<pre className="whitespace-pre-wrap bg-muted p-6 rounded-lg text-lg">
										{result.scenarios}
									</pre>
								</div>
								<div>
									<h4 className="text-xl font-medium mb-3">Market Personas:</h4>
									<pre className="whitespace-pre-wrap bg-muted p-6 rounded-lg text-lg">
										{result.personas}
									</pre>
								</div>
								<div>
									<h4 className="text-xl font-medium mb-3">Analysis & Feedback:</h4>
									<pre className="whitespace-pre-wrap bg-muted p-6 rounded-lg text-lg">
										{result.feedback}
									</pre>
								</div>
